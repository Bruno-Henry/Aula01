...
# print(f' 1 - Contéudo da Lista: {ndarray1}, o tamanho: {len(ndarray1)}')
# ndarray1 = numpy.ones(100000)
# print(f' 2 - Contéudo da Lista: {ndarray1}, o tamanho: {len(ndarray1)}')
...
# rng = numpy.random.default_rng()  # numpy tem seu método random incluso
# vetor = rng.random(4)
